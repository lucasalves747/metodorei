      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto space-y-10 md:space-y-16">
          ...
          <div className="space-y-4 md:space-y-6">
            <h3 className="text-xl md:text-2xl font-bold text-center text-primary mb-6 md:mb-8 px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {pillars.map((pillar, index) => (
                <div 
                  key={index}
                  className={`group relative p-6 md:p-8 bg-card border border-border rounded-2xl hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_40px_rgba(212,175,55,0.2)] ${
