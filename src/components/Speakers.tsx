        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6 p-6 bg-card border border-border rounded-2xl">
              ...
              <div className="space-y-4 text-foreground/80 leading-relaxed text-sm">
                <p>
                  Cristão, casado com Carol Marçal, pai do Lorenzo, Benjamin, Miguel e Isabela. Aos 36 anos, 
                  se tornou um dos <span className="text-primary font-bold">patriarcas mais prósperos do Brasil</span>.
                </p>
                
                <p>
                  Nas redes sociais é assistido por mais de <span className="text-primary font-bold">20 milhões de pessoas por mês</span>.
                </p>
                
                <p>
                  Multiempreendedor, mentor, escritor, piloto de corrida e investidor. Lidera como CVO um grupo multibilionário 
                  nos ramos imobiliário, digital, ensino, seguros, vendas, automobilístico, aviação, tecnologia, hotelaria e outros.
                </p>
                
                <p className="text-foreground font-medium">
                  Seu propósito é ativar a identidade e clarificar o propósito das pessoas que se conectem a ele. 
                  Seu maior desafio é transformar a mentalidade do povo brasileiro.
                </p>
              </div>
            </div>
          </div>
